...
class ProductPriceArea extends StatefulWidget {
  ...
  ProductPriceArea({@required this.product, this.id, this.appState});

  @override
  State<StatefulWidget> createState() {
    return ProductPriceAreaState(product, id, appState);
  }
}
...
class ProductPriceAreaState extends State<ProductPriceArea> {
  ...
  void initState() {
    ...
    ref = db.collection(Constants.PRODUCTS).document(product.documentId);
    _productInFavorites();
    _productInShoppingCart();
  }

  ProductPriceAreaState(this.product, this.id, this.appState);
